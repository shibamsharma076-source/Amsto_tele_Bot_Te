...
SPAM_VECTORIZER_PATH = 'vectorizer.pkl'
SPAM_CLASSIFIER_PATH = 'classifier.pkl'
DISEASE_DATASET_PATH = 'disease_dataset.csv'
DISEASE_CLASSIFIER_PATH = 'disease_classifier.pkl'
SYMPTOM_COLUMNS_PATH = 'symptom_columns.pkl'
STUDY_GUIDE_DATASET_PATH = 'study_guide_dataset.csv'
SENTIMENT_VECTORIZER_PATH = 'sentiment_vectorizer.pkl'
SENTIMENT_CLASSIFIER_PATH = 'sentiment_classifier.pkl' # Corrected path if different from spam
CODE_ANALYSIS_DATASET_PATH = 'code_analysis_dataset.csv'
FAKE_NEWS_DATASET_PATH = 'fake_news_dataset.csv'
FAKE_NEWS_VECTORIZER_PATH = 'fake_news_vectorizer.pkl'
FAKE_NEWS_CLASSIFIER_PATH = 'fake_news_classifier.pkl'
INTERVIEW_QA_DATASET_PATH = 'interview_qa_dataset.csv' # New: Path to interview Q&A dataset
PLAGIARISM_CORPUS_PATH = '0plagiarism_corpus.csv' # Path to the local plagiarism corpus dataset
# Code Generation Dataset Path
CODE_GENERATION_DATASET_PATH = 'code_generation_dataset.csv' # New: Path to code generation dataset
# Recipe Dataset Path
RECIPE_DATASET_PATH = 'recipes_dataset.csv'
